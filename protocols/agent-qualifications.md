...
**Status:** Draft
**Purpose:** Maps the 12 SDLC-v2 role archetypes to the 7 Claude Code agents, defining what expertise, ISO standard ownership, and SDLC-v2 section ownership each agent inherits.

**Why 7, not 12:** The CTO/CISO expert assessment recommended collapsing SDLC-v2's 12 executive archetypes to match the actual team: 6 humans + 7 AI agents. Twelve separate agents would create "decision latency, artificial handoffs, policy inflation, documentation over velocity." Seven agents, each absorbing 1-5 archetypes, delivers the same expertise with startup-appropriate coordination overhead.

---

## 1. Consolidation Overview

| SDLC-v2 Archetype (12) | Assigned Agent (7) | Consolidation Type |
|---|---|---|
...
| _(none -- new)_ | SDLC Lead Agent | New orchestrator role, not in SDLC-v2 |
...
**Persona composite:** CEO's primary AI interface. Combines the orchestration instincts of a Chief of Staff with the cross-domain awareness of a program director. Ensures all 6 specialist agents produce consistent, non-contradictory artifacts within the SDLC-v2 framework.

**Expertise:**
- Multi-agent orchestration and work routing
- Cross-domain dependency detection
- SDLC-v2 framework compliance across all 18 sections
- Artifact consistency verification across specialist outputs
- Subagent spawning and coordination via Task tool

**SDLC-v2 section ownership:** None directly -- oversees all sections through coordination
...
## 3. SDLC-v2 Section Ownership Map

| SDLC-v2 Section | Primary Agent | Source Archetype |
|---|---|---|
...
| Agent | Archetypes Absorbed | Primary ISOs | Secondary ISOs | SDLC-v2 Sections Owned | Created In |
|---|---|---|---|---|---|
...
*Reference: SDLC-v2.md Section 7 (Organizational Model), PROJECT.md (Constraints)*
